...
class Vehicle extends Model
{
    ...
    public const PUBLIC_AVAILABILITIES = [
        'listed' => 'available',
        'reserved' => 'reserved',
    ];

    public const PUBLIC_DESCRIPTION_MAX_LENGTH = 2000;
    ...
    {
        return array_keys(self::PUBLIC_AVAILABILITIES);
    }

    public function publicAvailability(): string
    {
        return self::PUBLIC_AVAILABILITIES[$this->status]
            ?? throw new LogicException("Unsupported public vehicle status: {$this->status}");
    }
