...
// 若只有手動指令、沒有排程/佇列自動重試，暫時性 storage 故障可能在無人發現前一直卡住。這裡把既有的
...
// 退化時，公開網址指向的檔案可能無限期留著卻完全沒人發現。appendOutputTo
// 把每次執行結果持久化成獨立 log 檔，onFailure
...
// 的上傳看起來像是成功上傳了一部分，持續佔用每台車 60 張上限。這裡把
