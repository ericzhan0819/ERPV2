...
第 4 部分 adversarial review 後，本月收入／支出導流已補 `approval=approved`，常數／空趨勢、權限 helper 與圖表欄數亦已修正。尚有一項需產品裁決的規格衝突：企劃要求本月毛利／成交導流保留月份，但既定 Vehicle Filter 契約沒有成交日期；目前只保留 `status=sold`，不得在未修訂企劃／PLAN 前自行新增日期 Filter。
