...
- [x] 建立草稿時才以 `findEffectiveForMonth()` 嚴格選取當下最新有效方案，並固定寫入 `commission_plan_id`
- [x] 若無有效方案，422 阻擋
...
- [x] full backend suite 通過（第 7 部分 review 修正後：455 tests、446 passed、9 environment-gated skipped）
